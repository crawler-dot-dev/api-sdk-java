...
dependencies {
    testImplementation(project(":api-crawler-dev-sdks-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../api-crawler-dev-sdks-java-core/src/main/resources/META-INF/proguard/api-crawler-dev-sdks-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.configure_me_apicrawlerdev_sdks.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../api-crawler-dev-sdks-java-core/src/main/resources/META-INF/proguard/api-crawler-dev-sdks-java-core.pro",

...
dependencies {
    testImplementation(project(":crawler-dev-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../crawler-dev-java-core/src/main/resources/META-INF/proguard/crawler-dev-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.configure_me_crawlerdev.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../crawler-dev-java-core/src/main/resources/META-INF/proguard/crawler-dev-java-core.pro",

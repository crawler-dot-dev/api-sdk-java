...
/**
 * A client for interacting with the Crawler Dev REST API asynchronously. You can also switch to
 ...
 * may call [close].
 */
interface CrawlerDevClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): CrawlerDevClientAsync
    ...
    /**
     * A view of [CrawlerDevClientAsync] that provides access to raw HTTP responses for each method.
     */

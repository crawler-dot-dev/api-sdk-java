package com.configure_me_crawlerdev.api.core.http

import com.configure_me_crawlerdev.api.core.DefaultSleeper
...
import com.configure_me_crawlerdev.api.errors.CrawlerDevRetryableException
...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean =
        ...
        throwable is IOException ||
            throwable is CrawlerDevIoException ||
            throwable is CrawlerDevRetryableException

...
import com.configure_me_crawlerdev.api.core.http.HttpRequestBody
import com.configure_me_crawlerdev.api.core.http.HttpResponse
import com.configure_me_crawlerdev.api.errors.CrawlerDevIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw CrawlerDevIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
            ...
            .enqueue(
                object : Callback {
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        future.completeExceptionally(CrawlerDevIoException("Request failed", e))
                    }
                }
            )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("CRAWLER_DEV_LOG")?.lowercase()) {

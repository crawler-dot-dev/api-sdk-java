...
import com.configure_me_crawlerdev.api.client.CrawlerDevClientImpl
...
/**
 * A class that allows building an instance of [CrawlerDevClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class CrawlerDevOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [CrawlerDevClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): CrawlerDevClient = builder().fromEnv().build()
    }

    /** A builder for [CrawlerDevOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [CrawlerDevClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CrawlerDevClient =
            CrawlerDevClientImpl(
                clientOptions
                    .httpClient(

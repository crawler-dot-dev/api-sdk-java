...
package com.configure_me_crawlerdev.api.client.okhttp

import com.configure_me_crawlerdev.api.client.CrawlerDevClientAsync
import com.configure_me_crawlerdev.api.client.CrawlerDevClientAsyncImpl
import com.configure_me_crawlerdev.api.core.ClientOptions
import com.configure_me_crawlerdev.api.core.Sleeper
import com.configure_me_crawlerdev.api.core.Timeout
import com.configure_me_crawlerdev.api.core.http.Headers
import com.configure_me_crawlerdev.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [CrawlerDevClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class CrawlerDevOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [CrawlerDevClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): CrawlerDevClientAsync = builder().fromEnv().build()
    }

    /** A builder for [CrawlerDevOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.configure_me_crawlerdev.api.core.jsonMapper]. The default is usually
         ...
         *
         * Defaults to the production environment: `https://api.crawler.dev`.
         */
        ...
        /**
         * Returns an immutable instance of [CrawlerDevClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CrawlerDevClientAsync =
            CrawlerDevClientAsyncImpl(
                clientOptions
                    .httpClient(

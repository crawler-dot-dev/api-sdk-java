...
[![Maven Central](https://img.shields.io/maven-central/v/com.configure_me_crawlerdev.api/crawler-dev-java)](https://central.sonatype.com/artifact/com.configure_me_crawlerdev.api/crawler-dev-java/0.2.0)
[![javadoc](https://javadoc.io/badge2/com.configure_me_crawlerdev.api/crawler-dev-java/0.2.0/javadoc.svg)](https://javadoc.io/doc/com.configure_me_crawlerdev.api/crawler-dev-java/0.2.0)
...
Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.configure_me_crawlerdev.api/crawler-dev-java/0.2.0).
...
```kotlin
implementation("com.CONFIGURE_ME_crawlerdev.api:crawler-dev-java:0.2.0")
```

...
/**
 * A class that allows building an instance of [ApiCrawlerDevSdksClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class ApiCrawlerDevSdksOkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [ApiCrawlerDevSdksClientAsync].
         */
         ...
         */
        @JvmStatic fun fromEnv(): ApiCrawlerDevSdksClientAsync = builder().fromEnv().build()
    }

    /** A builder for [ApiCrawlerDevSdksOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ApiCrawlerDevSdksClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiCrawlerDevSdksClientAsync =
            ApiCrawlerDevSdksClientAsyncImpl(
                clientOptions
                    .httpClient(

...
import com.configure_me_apicrawlerdev_sdks.api.core.http.HttpRequestBody
import com.configure_me_apicrawlerdev_sdks.api.core.http.HttpResponse
import com.configure_me_apicrawlerdev_sdks.api.errors.ApiCrawlerDevSdksIoException
...
internal constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw ApiCrawlerDevSdksIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(ApiCrawlerDevSdksIoException("Request failed", e))
                }
            }
        )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("API_CRAWLER_DEV_SDKS_LOG")?.lowercase()) {

...
package com.configure_me_apicrawlerdev_sdks.api.client.okhttp

import com.configure_me_apicrawlerdev_sdks.api.client.ApiCrawlerDevSdksClient
import com.configure_me_apicrawlerdev_sdks.api.client.ApiCrawlerDevSdksClientImpl
...
/**
 * A class that allows building an instance of [ApiCrawlerDevSdksClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class ApiCrawlerDevSdksOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [ApiCrawlerDevSdksClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): ApiCrawlerDevSdksClient = builder().fromEnv().build()
    }

    /** A builder for [ApiCrawlerDevSdksOkHttpClient]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.configure_me_apicrawlerdev_sdks.api.core.jsonMapper]. The default is
        ...
        /**
         * Returns an immutable instance of [ApiCrawlerDevSdksClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiCrawlerDevSdksClient =
            ApiCrawlerDevSdksClientImpl(
                clientOptions
                    .httpClient(

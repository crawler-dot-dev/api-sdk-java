...
import com.configure_me_apicrawlerdev_sdks.api.client.okhttp.OkHttpClient
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw ApiCrawlerDevSdksRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            ApiCrawlerDevSdksRetryableException("Simulated retryable failure")
                        )
                        return future
                    }

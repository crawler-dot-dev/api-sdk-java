...
/**
 * A client for interacting with the API Crawler Dev SDKs REST API asynchronously. You can also
 ...
 * may call [close].
 */
interface ApiCrawlerDevSdksClientAsync {
     ...
     * this client.
     */
    fun sync(): ApiCrawlerDevSdksClient
    ...
    /**
     * A view of [ApiCrawlerDevSdksClientAsync] that provides access to raw HTTP responses for each
     * method.
     */

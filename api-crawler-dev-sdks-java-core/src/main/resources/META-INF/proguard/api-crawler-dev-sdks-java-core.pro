...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.configure_me_apicrawlerdev_sdks.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.configure_me_apicrawlerdev_sdks.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.configure_me_apicrawlerdev_sdks.api.** {
    <init>(...);
